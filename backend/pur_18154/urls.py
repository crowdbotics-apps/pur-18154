...
admin.site.site_header = "Pur"
admin.site.site_title = "Pur Admin Portal"
admin.site.index_title = "Pur Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Pur API",
        default_version="v1",
        description="API documentation for Pur App",
    ),
    public=True,
